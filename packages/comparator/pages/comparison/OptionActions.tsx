...
export const OptionActions = memo(function OptionActions({
  ...
  return (
    <div className="absolute top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 scale-0 group-hover:scale-100 group-focus-within:scale-100 right-0 -translate-x-1/2 transition-all">
